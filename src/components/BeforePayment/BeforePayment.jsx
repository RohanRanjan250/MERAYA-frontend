    ...
    <>
        <div className={styles.heading}>
            <div className={styles.steps}>
                ...
                <p className={styles.wishlist}>ADDRESS</p>
                <p className={styles.whiteLine}></p>
                <p className={styles.current}>CART SUMMARY</p>
            </div>
        ...
        {/* Left - Cart Items */}
          ...
          <div className={styles.right}>
              <OrderSummary price={price} discount={discount} shipping={shipping} total={total} label="PAY NOW" onClick={nav}/>
          </div>
        </div>
    </>
  );
